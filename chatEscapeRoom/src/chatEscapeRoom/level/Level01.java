...
public class Level01 extends DungeonLevel {
  ...
  private void createObjects()  {
    ...
    DrawComponent drawComponentBlue = new DrawComponent(new SimpleIPath("escapeRoom/assets/objects/push-stone.png"));
    DrawComponent drawComponentRed = new DrawComponent(new SimpleIPath("escapeRoom/assets/objects/push-stone.png"));
